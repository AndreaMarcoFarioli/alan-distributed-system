...
public class DatabaseComUnit extends UnicastRemoteObject implements InterComChannel, AutoCloseable {
    ...
    private final Storage internalStorage = new LocalStorage();
    ...
    private static final String
        NUM_PROC = "num_proc_over",
        AVG_BIT_TIME = "avg_time_bit";
    ...
    public DatabaseComUnit(Propagator propagator, int port) throws RemoteException {
        ...
        this.port = port;
        internalStorage.setParameter(NUM_PROC, new AtomicInteger());
        internalStorage.setParameter(AVG_BIT_TIME, new AtomicLong());
        createNode();
